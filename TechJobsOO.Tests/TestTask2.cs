...
namespace TechJobsOO.Tests
{
	...
	public class TestTask2
	{
        ...
        public void Test_Second_Location_Constructor_Initializes_Id()
        {
            ...
            Location testLocation2 = new Location("Rainforest");

            //verify
            Assert.AreEqual(testLocation1.Id + 1, testLocation2.Id, "Second constructor not able to update Id");
            Assert.IsFalse(testLocation2.Id == testLocation1.Id, "Second constructor passes value to Id. Is this desirable?");
        }
